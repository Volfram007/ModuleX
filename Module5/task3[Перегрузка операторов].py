...
2. Создайте инициализатор `__init__` для класса `Building`, который будет задавать целочисленный атрибут `self.numberOfFloors` и строковый атрибут `self.buildingType`.
